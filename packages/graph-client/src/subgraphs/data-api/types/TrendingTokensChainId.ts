...
export const TrendingTokensChainIds = [
  42161, 42170, 43114, 8453, 288, 56288, 56, 42220, 1, 250, 100, 137, 534352,
  2222, 1088, 199, 7000, 1116, 108, 10, 59144, 81457, 2046399126, 30, 146,
  43111, 25, 5000, 324, 169, 34443, 167000, 810180, 33139, 1101, 1284,
] as const
