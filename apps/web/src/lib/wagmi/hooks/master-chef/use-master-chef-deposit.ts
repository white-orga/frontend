...
import type { Amount, Token } from 'citea/currency'
...
import { ChefType, type EvmChainId } from 'citea'
import { masterChefV1Abi_deposit, masterChefV2Abi_deposit } from 'citea/abi'
